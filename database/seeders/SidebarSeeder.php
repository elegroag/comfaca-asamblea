    ...
    public function run(): void
    {
        $menuItems = [
            ...
            [
                ...
                'hijos' => [
                    [
                        ...
                        'estado' => 'activo',
                        'resource_router' => 'recepcion#registro-ingresos',
                        'orden' => 1,
                        'ambiente' => 'todos',
                    ...
                    [
                        ...
                        'estado' => 'activo',
                        'resource_router' => 'recepcion#control-acceso',
                        'orden' => 2,
                        'ambiente' => 'todos',
                    ...
                    [
                        'label' => 'Rechazados',
                        'estado' => 'activo',
                        'resource_router' => 'recepcion#rechazados',
                        'orden' => 3,
                        'ambiente' => 'todos',
                    ...
                    [
                        'label' => 'Crear',
                        'estado' => 'activo',
                        'resource_router' => 'recepcion#crear-registro',
                        'orden' => 4,
                        'ambiente' => 'todos',
                        'icon' => 'nc-icon nc-simple-add',
                    ],
                    [
                        'label' => 'Listar Inscritos',
                        'estado' => 'activo',
                        'resource_router' => 'recepcion#listar-inscritos',
                        'orden' => 5,
                        'ambiente' => 'todos',
                        'icon' => 'nc-icon nc-single-02',
                    ],
                    [
                        ...
                        'estado' => 'activo',
                        'resource_router' => 'recepcion#registros-pendientes',
                        'orden' => 6,
                        'ambiente' => 'todos',
            ...
            [
                ...
                'hijos' => [
                    [
                        'label' => 'Listar Habiles',
                        'estado' => 'activo',
                        'resource_router' => 'habiles#habiles',
                        'orden' => 3,
                        'ambiente' => 'todos',
                        'icon' => 'nc-icon nc-list-67',
                    ],
                    [
                        'label' => 'Listar Empresas',
                        'estado' => 'activo',
                        'resource_router' => 'habiles#listar',
                        'orden' => 3,
                        'ambiente' => 'todos',
                        'icon' => 'nc-icon nc-list-67',
                    ],
                    ...
                    [
                        'label' => 'Carga Masiva',
                        'estado' => 'activo',
                        'resource_router' => 'habiles#masivo',
                        'orden' => 5,
                        'ambiente' => 'todos',
                    ...
                    [
                        ...
                        'estado' => 'activo',
                        'resource_router' => 'habiles#representantes',
                        'orden' => 6,
                        'ambiente' => 'todos',
                        'icon' => 'nc-icon nc-badge',
                    ],
